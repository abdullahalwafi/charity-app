...
<html lang="en">
    <head>
        ...
        <meta
            name="description"
            content="Careoxis a clean professional Non Profit Charity HTML Template. Which fits for all kind of charity, fundraising, nonprofit, NGO, donations, church, Mosque and all other non-profit charity website, businesses and NGO."
        />
    ...
    <body class="custom-cursor">
        ...
        <div class="page-wrapper">
            <div class="topbar-one">
                <div class="container">
                    <div class="topbar-one__inner">
                        <p class="topbar-one__info">
                            Wellcome To <span> Careox !</span>
                        </p>
                        <!-- /.topbar-one__text -->
                        <div class="topbar-one__social">
                            <p class="topbar-one__social__text">
                ...
                <div class="topbar-one__bottom">
                    <div class="container">
                        <div class="topbar-one__bottom__inner">
                            ...
                            <div class="topbar-one__bottom__right">
                                <div
                                    class="topbar-one__bottom__info"
                                    style="--accent-color: #ffa415"
                                >
                                    ...
                                    <div
                                        class="topbar-one__bottom__info__content"
                                    >
                                        <h5
                                            class="topbar-one__bottom__info__text"
                                        >
                                            <a href="tel:+0449123452"
                                                >+0(449) 123 452</a
                                            >
                                        </h5>
                                        <p
                                            class="topbar-one__bottom__info__title"
                                        >
                                            Requesting a Call:
                                        </p>
                                    </div>
                    ...
                    <div class="topbar-one__bottom__button">
                        <img
                            src="assets/images/shapes/arrow-1.png"
                            alt="careox"
                        />
                        <a href="donate.html" class="careox-btn"
                            ><span
                                ><i class="icofont-heart"></i>Donate Now</span
                            ></a
                        >
                    </div>
                </div>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="dropdown">
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="donations-one.html"
                                                        >Donations 01</a
                                                    >
                                                </li>
                                                <li>
                                                    <a href="donations-two.html"
                                                        >Donations 02</a
                                                    >
                                                </li>
                                                <li>
                                                    <a
                                                        href="donations-three.html"
                                                        >Donations 03</a
                                                    >
                                                </li>
                                            </ul>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="sub-menu">
                                                <li>
                                                    <a
                                                        href="donations-four.html"
                                                        >Donations 01</a
                                                    >
                                                </li>
                                                <li>
                                                    <a
                                                        href="donations-five.html"
                                                        >Donations 02</a
                                                    >
                                                </li>
                                                <li>
                                                    <a href="donations-six.html"
                                                        >Donations 03</a
                                                    >
                                                </li>
                                            </ul>
                                    ...
                                    <ul class="sub-menu">
                                        <li class="dropdown">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li>
                                                    <a href="products-left.html"
                                                        >Left Sidebar</a
                                                    >
                                                </li>
                                                <li>
                                                    <a
                                                        href="products-right.html"
                                                        >Right Sidebar</a
                                                    >
                                                </li>
                                            </ul>
            ...
            <section class="main-slider-one">
                <div
                    class="main-slider-one__carousel careox-owl__carousel owl-carousel"
                    data-owl-options='{
		"loop": true,
		"animateOut": "fadeOut",
		"animateIn": "fadeIn",
		...
		"margin": 0
                    ...
                    <div class="item">
                        <div class="main-slider-one__item">
                            <div
                                ...
                                style="
                                    background-image: url(assets/images/backgrounds/slider-1-1.jpg);
                                "
                            ></div>
                            <svg
                            ...
                            <div
                                class="main-slider-one__layer"
                                style="
                                    background-image: url(assets/images/shapes/slider-1-layer-bg.png);
                                "
                            >
                                <div class="main-slider-one__layer__inner">
                                    <img
                                        src="assets/images/backgrounds/slider-1-layer-1.jpg"
                                        alt="careox"
                                    />
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="main-slider-one__content">
                                            <div class="main-slider-one__image">
                                                <img
                                                    src="assets/images/shapes/slider-1-arrow.png"
                                                    alt="careox"
                                                />
                                                <img
                                                    src="assets/images/shapes/slider-1-hand.png"
                                                    alt="careox"
                                                />
                                            </div>
                                            <!-- slider-sub-title -->
                                            <h2 class="main-slider-one__title">
                                                Give Child Poor <br />Gift
                                                Helping Now.
                                            </h2>
                                            <!-- slider-title -->
                                            <p class="main-slider-one__text">
                                                Poor can only be as strong as
                                                our people & because of team<br />
                                                have designed game changing
                                                products.
                                            </p>
                                            <!-- slider-text -->
                    ...
                    <div class="item">
                        <div class="main-slider-one__item">
                            ...
                            >
                                <div class="main-slider-one__layer__inner">
                                    <img
                                        src="assets/images/backgrounds/slider-1-layer-2.jpg"
                                        alt="careox"
                                    />
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class="main-slider-one__item">
                            ...
                            >
                                <div class="main-slider-one__layer__inner">
                                    <img
                                        src="assets/images/backgrounds/slider-1-layer-3.jpg"
                                        alt="careox"
                                    />
                                </div>
                            </div>
            ...
            <section class="cta-one">
                <div class="container-fluid">
                    <div
                        class="cta-one__shape-middle"
                        style="
                            background-image: url(assets/images/shapes/cta-1-shape-2.png);
                        "
                    ></div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div
                                class="cta-one__content"
                                style="
                                    background-image: url(assets/images/backgrounds/cta-bg-1-1.jpg);
                                "
                            >
                                <h3 class="cta-one__title">Become Volunteer</h3>
                                <p class="cta-one__text">
                                    Lorem ipsum dolor sit amet, conse dtetur
                                    adipi sicing
                                    <br />elitare many variations.
                                </p>
                                <a href="contact.html" class="careox-btn"
                        ...
                        <div class="col-lg-6">
                            <div
                                class="cta-one__content cta-one__content--right"
                                style="
                                    background-image: url(assets/images/backgrounds/cta-bg-1-2.jpg);
                                "
                            >
                                ...
                                >
                                <div
                                    class="cta-one__content__shape"
                                    style="
                                        background-image: url(assets/images/shapes/cta-1-shape-1.png);
                                    "
                                ></div>
                            </div>
                        </div>
            ...
            <section class="about-one">
                <div class="about-one__shape">
                    <img
                        src="assets/images/shapes/about-1-shape-4.png"
                        alt="careox"
                    />
                </div>
                <div class="container">
                        ...
                        <div class="col-xl-6">
                            ...
                            >
                                ...
                                <div class="about-one__image__shape-one">
                                    <img
                                        src="assets/images/shapes/about-1-shape-1.png"
                                        alt="careox"
                                    />
                                </div>
                                <div class="about-one__image__shape-two">
                                    <img
                                        src="assets/images/shapes/about-1-shape-2.png"
                                        alt="careox"
                                    />
                                </div>
                        ...
                        >
                            <div class="about-one__content">
                                <div class="sec-title text-left">
                                    ...
                                    >
                                        We Believe This Lifes About Give For
                                        Poor People.
                                    </h3>
                                    <!-- /.sec-title__title -->
                                </div>
                                ...
                                <p class="about-one__content__text">
                                    Poor address a range of simply application
                                    and infrastructure this of passages of
                                ...
                                <div class="row gutter-y-30">
                                    <div class="col-md-6">
                                        <div
                                            class="about-one__content__box"
                                            style="--accent-color: #ffa415"
                                        >
                                            <div
                                                class="about-one__content__box__top"
                                            >
                                                <div
                                                    class="about-one__content__box__icon"
                                                >
                                                    <span
                                                        class="icon-zakat"
                                                    ></span>
                                            ...
                                            >
                                                <span
                                                    class="about-one__content__box__text__icon"
                                                    ><i
                                ...
                                <ul class="about-one__content__list">
                                    <li>
                                        <span
                                            class="about-one__content__list__icon"
                                            ><i
                                                class="icofont-check-circled"
                                            ></i
                                        ></span>
                                        We help companies develop powerful
                                        corporate social
                                ...
                                <a href="about.html" class="careox-btn"
                                    ><span>About More</span></a
                                >
                            </div>
                            <!-- /.about__content -->
                        </div>
                    ...
                    <div class="about-one__text wow fadeInUp">
                        <span>#</span> We Give Donations Poor People Impact on
                        Someone’s Life.
                        <a href="donation.html" class="careox-btn"
            ...
            <section class="funfact-one">
                <div class="container wow fadeInUp">
                    <ul class="list-unstyled funfact-one__list">
                        <li
                            class="funfact-one__item count-box"
                            style="--accent-color: #ffa415"
                        >
            ...
            <section class="service-one">
                <div
                    class="service-one__shape-one"
                    style="
                        background-image: url(assets/images/shapes/service-bg-shape-1.png);
                    "
                ></div>
                <div
                    class="service-one__shape-two"
                    style="
                        background-image: url(assets/images/shapes/service-bg-shape-2.png);
                    "
                ></div>
                <div class="container">
                    <div class="sec-title text-center">
                        ...
                        <h3 class="sec-title__title bw-split-in-left">
                            We Help Poor This Lifes <br />Service Now
                        </h3>
                        <!-- /.sec-title__title -->
                    </div>
                    <!-- /.sec-title -->
                    <div class="row gutter-y-30">
                        ...
                        >
                            <div
                                class="service-one__item text-center"
                                style="--accent-color: #ffa415"
                            >
                                ...
                                <p class="service-one__item__text">
                                    With schools closed in NSW and Victoria, and
                                    childcare workers in places.
                                </p>
                                <!-- /.service-title -->
            ...
            <section class="donations-one">
                <div class="container">
                    <div class="sec-title text-left">
                        ...
                        <h3 class="sec-title__title bw-split-in-left">
                            Help & Donate Now Find <br />The Popular Cause
                        </h3>
                        <!-- /.sec-title__title -->
                    </div>
                    <!-- /.sec-title -->
                    <div
                        class="donations-one__carousel careox-owl__carousel owl-carousel"
                        data-owl-options='{
			"items": 1,
			"margin": 30,
			"loop": false,
			...
			"responsive": {
				...
				"992": {
                    ...
                    >
                        <div class="item">
                            <div
                                class="donations-one__item"
                                style="--accent-color: #ffa415"
                            >
                                <div class="donations-one__item__image">
                                    <img
                                        src="assets/images/donation/donation-1-1.jpg"
                                        alt="careox"
                                    />
                                    <a
                                        href="donation-details.html"
                                        class="donations-one__item__image__link"
                                    ></a>
                                    <div class="donations-one__item__category">
                                        Poor
                                    </div>
                                </div>
                                <div class="donations-one__item__content">
                                    <h3 class="donations-one__item__title">
                                        <a href="donation-details.html"
                                            >We Can Aenean Poor leo Nec This
                                            Rnare.</a
                                        >
                                    </h3>
                                    <p class="donations-one__item__text">
                                        We poor standard chunk ofI nibh velit
                                        auctor aliquet sollic tudin.
                                    </p>
                                    <a
                                        class="donations-one__item__rm"
                                        href="donation-details.html"
                                        ><i class="icon-right-arrow"></i
                                    ></a>
                                </div>
                                <div class="donations-one__item__bottom">
                                    <div
                                        class="donations-one__item__bottom__shape"
                                        style="
                                            background-image: url(assets/images/shapes/d-shape-1.png);
                                        "
                                    ></div>
                                    <div
                                        class="donations-one__item__bottom__progress"
                                    >
                                        <div
                                            class="donations-one__item__bottom__progress__inner count-bar"
                                            data-percent="85%"
                                        >
                                            <div
                                                class="donations-one__item__bottom__progress__number count-text"
                                            >
                                                85%
                                            </div>
                                        </div>
                                    ...
                                    <!-- /.progress-box -->
                                    <div
                                        class="donations-one__item__bottom__text"
                                    >
                        ...
                        <div class="item">
                            ...
                            >
                                <div class="donations-one__item__image">
                                    <img
                                        src="assets/images/donation/donation-1-2.jpg"
                                        alt="careox"
                                    />
                                    <a
                                        href="donation-details.html"
                                ...
                                <div class="donations-one__item__bottom">
                                    <div
                                        class="donations-one__item__bottom__shape"
                                        style="
                                            background-image: url(assets/images/shapes/d-shape-2.png);
                                        "
                                    ></div>
                                    <div
                                        class="donations-one__item__bottom__progress"
                        ...
                        <div class="item">
                            <div
                                class="donations-one__item"
                                style="--accent-color: #8742e8"
                            >
                                <div class="donations-one__item__image">
                                    <img
                                        src="assets/images/donation/donation-1-3.jpg"
                                        alt="careox"
                                    />
                                    <a
                                        href="donation-details.html"
                                ...
                                <div class="donations-one__item__content">
                                    <h3 class="donations-one__item__title">
                                        <a href="donation-details.html"
                                            >Medical Health or People React
                                            Acutor.</a
                                        >
                                    </h3>
                                    <p class="donations-one__item__text">
                                ...
                                <div class="donations-one__item__bottom">
                                    <div
                                        class="donations-one__item__bottom__shape"
                                        style="
                                            background-image: url(assets/images/shapes/d-shape-3.png);
                                        "
                                    ></div>
                                    <div
                                        class="donations-one__item__bottom__progress"
                        ...
                        <div class="item">
                            ...
                            >
                                <div class="donations-one__item__image">
                                    <img
                                        src="assets/images/donation/donation-1-4.jpg"
                                        alt="careox"
                                    />
                                    <a
                                        href="donation-details.html"
                                ...
                                <div class="donations-one__item__content">
                                    <h3 class="donations-one__item__title">
                                        <a href="donation-details.html"
                                            >Let’s education for children good
                                            life.</a
                                        >
                                    </h3>
                                    <p class="donations-one__item__text">
                                ...
                                <div class="donations-one__item__bottom">
                                    <div
                                        class="donations-one__item__bottom__shape"
                                        style="
                                            background-image: url(assets/images/shapes/d-shape-4.png);
                                        "
                                    ></div>
                                    <div
                                        class="donations-one__item__bottom__progress"
            ...
            <section class="video-one">
                <div
                    class="video-one__bg jarallax"
                    data-jarallax
                    data-speed="0.3"
                    data-imgPosition="50% -100%"
                    style="
                        background-image: url(assets/images/backgrounds/video-bg-1-1.jpg);
                    "
                ></div>
                <!-- /.video-one__bg -->
                <div
            ...
            <section class="feature-one">
                <div
                    ...
                    style="
                        background-image: url(assets/images/shapes/feature-bg-1.png);
                    "
                ></div>
                <div class="container">
                    <div
                        ...
                        style="
                            background-image: url(assets/images/shapes/feature-1-shape-arrow.png);
                        "
                    ></div>
                    <div class="row gutter-y-30">
                        <div
                        ...
                        >
                            <div
                                class="feature-one__item"
                                style="--accent-color: #ffa415"
                            >
                                <div class="feature-one__item__inner">
                                    <div
                                        class="feature-one__item__shape"
                                        style="
                                            background-image: url(assets/images/shapes/feature-1-shape.png);
                                        "
                                    ></div>
                                    <div class="feature-one__item__icon">
                                        <span class="icon-zakat"></span>
                                    </div>
                                    <h3 class="feature-one__item__title">
                                        Treatment Help
                                    </h3>
                                    ...
                                    <div
                                        class="feature-one__item__number"
                                    ></div>
                                    <a
                                        href="about.html"
                                        class="feature-one__item__rm"
                                        ><span class="icon-up-arrow-two"></span
                                    ></a>
                                </div>
                            </div>
                            <!-- feature-item -->
                        ...
                        >
                            <div
                                class="feature-one__item feature-one__item--reverse"
            ...
            <section class="team-one">
                <div class="container">
                    ...
                    <!-- /.sec-title -->
                    <div
                        class="team-one__carousel careox-owl__carousel careox-owl__carousel--with-shadow careox-owl__carousel--basic-nav owl-carousel"
                        data-owl-options='{
			"items": 1,
			"margin": 30,
			"loop": false,
            ...
            <div class="client-carousel">
                <div class="container">
                    <div
                        class="client-carousel__one careox-owl__carousel owl-theme owl-carousel"
                        data-owl-options='{
            "items": 5,
            "margin": 30,
            "smartSpeed": 700,
                ...
                "1200":{
                    ...
                    >
                        <div class="client-carousel__one__item">
                            <img
                                class="client-carousel__one__item__normal"
                                src="assets/images/resources/brand-1-1.png"
                                alt="careox"
                            />
                            <img
                                class="client-carousel__one__item__hover"
            ...
            <section class="testimonials-one">
                <div
                    ...
                    style="
                        background-image: url(assets/images/shapes/testimonial-bg-1.png);
                    "
                ></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <p class="testimonials-one__text">
                                Poor address a range of simply application and
                            ...
                            <ul
                                class="testimonials-one__image careox-slick__carousel"
                                data-slick-options='{
					"slidesToShow": 3,
					"slidesToScroll": 1,
					"autoplay": true,
            		...
            		"prevArrow": "<button class=\"prev\"><i class=\"icon-right-arrow-two\"></i></button>"
                            ...
                            >
                                ...
                                <li role="presentation">
                                    <div
                                        class="testimonials-one__image__item"
                                        style="--accent-color: #ffa415"
                                    >
                                        <img
                        ...
                        <div class="col-lg-6">
                            <div
                                class="testimonials-one__wrapper"
                                style="
                                    background-image: url(assets/images/resources/testimonail-1-bg.jpg);
                                "
                            >
                                <div
                                    class="testimonials-one__carousel careox-slick__carousel"
                                    data-slick-options='{
						"slidesToShow": 2,
						"slidesToScroll": 1,
						"vertical": true,
						...
						"responsive": [
							{
                                ...
                                >
                                    <div class="item">
                                        <div
                                            class="testimonials-card @@extraClassName"
                                            style="--accent-color: #ffa415"
                                        >
                                            <div
                                            ...
                                            <div
                                                class="testimonials-card__rating"
                                            >
                                            ...
                                            <p
                                                class="testimonials-card__designation"
                                            >
                                                Founder
                                            </p>
            ...
            <section class="donate-one">
                <div
                    class="donate-one__bg"
                    style="
                        background-image: url(assets/images/backgrounds/donate-bg-1.jpg);
                    "
                ></div>
                <div class="donate-one__image wow fadeInLeft">
                    <img
                        src="assets/images/resources/donate-1-1.png"
                        alt="careox"
                    />
                </div>
            </section>
            <section class="donate-info">
                <div
                    class="donate-info__shape"
                    style="
                        background-image: url(assets/images/resources/donate-info-shape.png);
                    "
                ></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4">
                            <div
                                class="donate-info__left"
                                style="
                                    background-image: url(assets/images/backgrounds/donate-info-bg.jpg);
                                "
                            >
                                <div class="donate-info__left__icon">
                                    <span class="icon-charity-two"></span>
                                </div>
                                <h5 class="donate-info__left__title">
                                    Donate Now
                                </h5>
                                <p class="donate-info__left__text">
                                    24/7 Support
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div
                                class="donate-info__area"
                                style="
                                    background-image: url(assets/images/shapes/donate-area-bg.jpg);
                                "
                            >
                                <div class="sec-title text-left">
                                    <h6
                                    ...
                                    <h3
                                        class="sec-title__title bw-split-in-left"
                                    >
                                        Get Inspire Donate Help <br />Change a
                                        life.
                                    </h3>
                                    <!-- /.sec-title__title -->
                                </div>
                                <!-- /.sec-title -->
                                <div class="donate-info__area__date">
                                    <i class="icofont-ui-calendar"></i>02 Sep
                                    2024
                                </div>
                                <div class="donate-info__area__progress">
                                    <div
                                        class="donate-info__area__progress__bar"
                                    >
                                        <div
                                            class="donate-info__area__progress__inner count-bar"
                                            data-percent="85%"
                                        >
                                            <div
                                                class="donate-info__area__progress__number count-text"
                                            >
                                                85%
                                            </div>
                                        </div>
                                    ...
                                    <!-- /.progress-box -->
                                    <div
                                        class="donate-info__area__progress__text"
                                    >
                                        <span>$23,000 Goals</span>
                                        <span>$9,000 Donate</span>
                                    </div>
                                ...
                                <form action="#" class="donate-info__form">
                                    <div class="donate-info__form__top">
                                        <div class="donate-info__form__amount">
                                            <span
                                                class="donate-info__form__amount__sign"
                                                >$</span
                                            >
                                            <input
                                                type="text"
                                        ...
                                        <div class="donate-info__form__buttons">
                                            ...
                                            >
                                                $<span
                                                    class="donate-info__form__buttons__amount"
                                                    >100</span
                                                >
                                            </button>
                                            <button
                                                type="button"
                                                class="donate-info__form__buttons__item active"
                                            >
                                                $<span
                                                    class="donate-info__form__buttons__amount"
                                                    >200</span
                                    ...
                                    <div class="donate-info__form__submit">
                                        ...
                                        <img
                                            src="assets/images/shapes/donate-arrow.png"
                                            alt="careox"
                                        />
                                    </div>
                                </form>
            ...
            <section class="blog-one">
                <div class="container">
                    ...
                    <div class="row gutter-y-30">
                            ...
                            >
                                <div class="blog-card__image">
                                    ...
                                    <a
                                        ...
                                        ><span class="sr-only"
                                            >We Can Aenean Poor to Help This
                                            People in Needleo Blog.</span
                                        >
                                        <!-- /.sr-only --></a
                                    >
                                    <div class="blog-card__date">
                                        <i class="icofont-ui-calendar"></i>02
                                        Sep 2024
                                    </div>
                                    <!-- /.blog-card__date -->
                                </div>
                                ...
                                <div class="blog-card__content">
                                    ...
                                    <h3 class="blog-card__title">
                                        <a href="blog-details-right.html"
                                            >We Can Aenean Poor to Help This
                                            People in Needleo Blog.</a
                                        >
                                    </h3>
                                    <!-- /.blog-card__title -->
                                    <p class="blog-card__text">
                                        We poor standard chunk nibh velit
                                        majority suffered alteration in some
                                        form aliquet sollic tudin.
                                    </p>
                                    <!-- /.blog-card__text -->
                                    <a
                                        href="blog-details-right.html"
                        ...
                        <div class="col-lg-7">
                            <div
                                class="blog-card blog-card--reverse wow fadeInUp"
                                data-wow-duration="1500ms"
                                data-wow-delay="100ms"
                                style="--accent-color: #ff5528"
                            >
                                ...
                                <div class="blog-card__image">
                                    <img
                                        ...
                                        alt="Our Donation is Hope for Poor Childrens."
                                    />
                                    <img
                                        src="assets/images/blog/blog-1-2.jpg"
                                        alt="Our Donation is Hope for Poor Childrens."
                            ...
                            >
                                ...
                                <div class="blog-card__image">
                                    <img
                                        ...
                                        alt="Help This People in Needleo Blog."
                                    />
                                    <img
                                        src="assets/images/blog/blog-1-3.jpg"
                                        alt="Help This People in Needleo Blog."
                ...
                <div class="container">
                    <ul class="info__wrapper">
                        ...
                        <li style="--accent-color: #ff5528">
                            <div class="info__icon">
                                <span class="icofont-envelope"></span>
                            </div>
                            <div class="info__content">
                                <h5 class="info__title">Email</h5>
                                <p class="info__text">
                                    <a href="mailto:careox@envato.com"
                                        >careox@envato.com</a
                                    >
                                </p>
                            </div>
            ...
            <footer class="main-footer background-black">
                ...
                <div class="container">
                    <div class="row">
                        <div
                            class="col-md-6 col-xl-4 wow fadeInUp"
                            data-wow-delay="100ms"
                        >
                            <div class="footer-widget footer-widget--about">
                                ...
                                <p class="footer-widget__text">
                                    We help businesses maximize their online
                                    presence with a personalized approach to
                                    digital marketing.
                                </p>
                        ...
                        <!-- /.col-md-6 -->
                        <div
                            class="col-md-6 col-xl-2 wow fadeInUp"
                            data-wow-delay="150ms"
                        >
                        ...
                        <!-- /.col-md-6 -->
                        <div
                            class="col-md-6 col-xl-3 wow fadeInUp"
                            data-wow-delay="200ms"
                        >
                            <div class="footer-widget footer-widget--links-two">
                                ...
                                <ul class="list-unstyled footer-widget__links">
                                    ...
                                    <li>
                                        <a href="blog-list.html">Our News</a>
                                    </li>
                                    <li>
                                        <a href="events-list.html"
                                            >Our Campaign</a
                            ...
                            <div class="footer-widget footer-widget--contact">
                                ...
                                <ul class="list-unstyled footer-widget__info">
                                    <li style="--accent-color: #ffa415">
                                        ...
                                        ></span>
                                        Open Hours of Government: Mon - Fri:
                                        8.00 am. - 6.00 pm.
                                    </li>
                                    <li style="--accent-color: #ff5528">
                                        <span class="footer-widget__info__icon"
                ...
                <!-- /.container -->
                <div
                    class="main-footer__bottom wow fadeInUp"
                    data-wow-delay="300ms"
                >
                    <div class="container">
                        <div class="main-footer__bottom__inner">
                            <p class="main-footer__copyright">
                                &copy; Copyright
                                <span class="dynamic-year"></span> by Careox
                                HTML Template.
                            </p>
                        </div>
                        <!-- /.main-footer__inner -->
            ...
            <div class="mobile-nav__content">
                ...
                <ul class="mobile-nav__contact list-unstyled">
                    <li>
                        ...
                        <a href="mailto:needhelp@careox.com"
                            >needhelp@careox.com</a
                        >
                    </li>
                    <li>
